...
export default function LoveLetter() {
    return (
        <section className="py-20 px-4 bg-white relative overflow-hidden">
            {/* Decorative petals */}
            <div className="absolute top-10 right-10 text-rose-200 text-6xl opacity-30 rotate-12">❤</div>
            <div className="absolute bottom-10 left-10 text-rose-200 text-4xl opacity-20 -rotate-12">❤</div>
            ...
            <div className="max-w-3xl mx-auto">
                ...
                >
                    <span className="font-dancing text-2xl text-rose-400 block mb-2">do fundo do coração</span>
                ...
                >
                    ...
                    <div className="bg-gradient-to-br from-rose-50 to-white rounded-3xl p-8 sm:p-12 shadow-xl shadow-rose-100/50 border border-rose-100 relative overflow-hidden">
                        ...
                        <p className="font-dancing text-2xl text-rose-500 mb-6">Meu amor,</p>
                        ...
                        <div className="font-inter text-rose-800/80 leading-loose text-base sm:text-lg space-y-6">
                            <p>
                                ...
                                As cores ficaram mais vibrantes, os dias mais alegres e cada momento
                                ganhou um significado especial.
                            </p>
                            <p>
                                Seu sorriso ilumina meus dias e seu carinho faz tudo valer a pena.
                                Quando estou ao seu lado, sinto que posso enfrentar qualquer coisa,
                                porque tenho o maior tesouro do mundo comigo.
                            </p>
                            <p>
                                Hoje é seu dia, mas quem ganha o presente sou eu — por ter você comigo.
                                Cada segundo ao seu lado é uma bênção que agradeço todos os dias.
                            </p>
                            <p>
                                Que esse novo ano da sua vida seja repleto de realizações,
                                alegrias e muito amor. Estarei sempre aqui, ao seu lado,
